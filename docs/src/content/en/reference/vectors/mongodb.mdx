...
VoyageAI provides specialized embedding models optimized for retrieval tasks. VoyageAI is also [integrated with MongoDB Atlas](https://www.mongodb.com/docs/atlas/architecture/current/solutions-library/semantic-video-search/) for multimodal embeddings.
