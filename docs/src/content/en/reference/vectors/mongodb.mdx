...
VoyageAI provides specialized embedding models optimized for retrieval tasks. To use VoyageAI with MongoDB Atlas Vector Search, generate embeddings via the [VoyageAI API](https://docs.voyageai.com/) and store them in your Atlas cluster.
