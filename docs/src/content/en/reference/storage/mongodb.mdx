...
<PropertiesTable
  ...
  },
  {
    ...
    description:
      'MongoDB client options for advanced configuration (SSL, connection pooling, etc.). @see https://www.mongodb.com/docs/drivers/node/current/fundamentals/connection/connection-options/',
    isOptional: true,
  },
  {
    name: 'disableInit',
  ...
  },
  {
    ...
    description:
      'Custom indexes to create during initialization. Each index must specify a collection, keys, and optional index options. @see https://www.mongodb.com/docs/manual/indexes/',
    isOptional: true,
  },
  {
